...
/// an overflow occured, the carry flag is set to 1, ortherwise it's set to 0.
...
pub fn jmp_instruction(console: &mut Console, opcode: u8) -> u32 {
    ...
    assert_eq!(opcode, 0x_00, "opcode {:#X} not associated to JMP instruction", opcode);
...
pub fn nop_instruction(console: &mut Console, opcode: u8) -> u32 {
    ...
    // Consume the opcode in order to move the pointer counter.
